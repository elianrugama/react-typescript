  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <Link to="/" className="block py-2 pl-3 pr-4 rounded texr-white  md:border-0  md:p-0 md:hover:text-blue-500 hover:bg-black md:hover:bg-transparent">
            Home
          </Link>
        </li>
        <li>
          <Link to="/products" className="block py-2 pl-3 pr-4 rounded  md:hover:bg-transparent">
          </Link>
        </li>
      </ul>
    </div>
